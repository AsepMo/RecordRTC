...
public class ServerService extends Service {
    ...
    private void createWebServer() {
        ...
        if (getResources().getConfiguration().locale.getCountry().equals("CN")) {
            webServer = WebServer.initChs(mAssetManager, v.getWebServerPort(), listener);
        } else {
            webServer = WebServer.init(mAssetManager, v.getWebServerPort(), listener);
        }

    }

    private void createWsServer() {
        wsServer = WsServer.init("0.0.0.0", v.getWsServerPort());
